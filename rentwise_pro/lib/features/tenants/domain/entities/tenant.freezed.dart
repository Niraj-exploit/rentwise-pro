...
mixin _$Tenant {
 ...
 String get id; String get name; String get phone; String? get email; String get unitId; DateTime get joinedDate; TenantStatus get status; double get balance;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,phone,email,unitId,joinedDate,status,balance);

@override
String toString() {
  return 'Tenant(id: $id, name: $name, phone: $phone, email: $email, unitId: $unitId, joinedDate: $joinedDate, status: $status, balance: $balance)';
}
...
@useResult
$Res call({
 String id, String name, String phone, String? email, String unitId, DateTime joinedDate, TenantStatus status, double balance
});
...
/// Create a copy of Tenant
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? phone = null,Object? email = freezed,Object? unitId = null,Object? joinedDate = null,Object? status = null,Object? balance = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  String phone,  String? email,  String unitId,  DateTime joinedDate,  TenantStatus status,  double balance)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Tenant() when $default != null:
return $default(_that.id,_that.name,_that.phone,_that.email,_that.unitId,_that.joinedDate,_that.status,_that.balance);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  String phone,  String? email,  String unitId,  DateTime joinedDate,  TenantStatus status,  double balance)  $default,) {final _that = this;
switch (_that) {
case _Tenant():
return $default(_that.id,_that.name,_that.phone,_that.email,_that.unitId,_that.joinedDate,_that.status,_that.balance);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String name,  String phone,  String? email,  String unitId,  DateTime joinedDate,  TenantStatus status,  double balance)?  $default,) {final _that = this;
switch (_that) {
case _Tenant() when $default != null:
return $default(_that.id,_that.name,_that.phone,_that.email,_that.unitId,_that.joinedDate,_that.status,_that.balance);case _:
  return null;
...
class _Tenant implements Tenant {
  const _Tenant({required this.id, required this.name, required this.phone, this.email, required this.unitId, required this.joinedDate, required this.status, this.balance = 0.0});
...
/// Create a copy of Tenant
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? phone = null,Object? email = freezed,Object? unitId = null,Object? joinedDate = null,Object? status = null,Object? balance = null,}) {
